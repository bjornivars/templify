<?php 
    ...
    $to   = "bjorn-ivar.skuggen@hotmail.com";    // Mottaker av skjema data
    $from = "templify@mail.com";  // Default avsender (endres hvis et av form-feltene har nøkkelen email, se under)
